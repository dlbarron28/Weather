...
public class WeatherFetcher {
    ...
    public WeatherItem fetchWeather(String location) {
        ...
        Log.i(TAG,"Starting fetch for " + location);
        try {
            String url = Uri.parse(ENDPOINT).buildUpon().appendQueryParameter("APPID","82bec7bfaf04817d548862f84d3e1015").appendQueryParameter("mode", MODE).appendQueryParameter("units", UNITS).appendQueryParameter("q",location).build().toString();
